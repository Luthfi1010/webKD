                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="payment-info-container">
                            ...
                            <p class="mb-4">
                                Punya pertanyaan atau butuh info lebih lanjut? Langsung aja klik kontak di bawah ini. Chat aja, jangan sungkan! 😄
                            </p>

                            <div class="row g-3">
                                <div class="col-md-6">
                                    <a href="https://wa.me/6281324249809" target="_blank" class="btn btn-outline-success w-100 d-flex align-items-center justify-content-center gap-2 shadow-sm py-3">
                                ...
                                <div class="col-md-6">
                                    <a href="https://wa.me/62882022422760" target="_blank" class="btn btn-outline-success w-100 d-flex align-items-center justify-content-center gap-2 shadow-sm py-3">
                                        <i class="fab fa-whatsapp fa-lg"></i>
                                        <div>
